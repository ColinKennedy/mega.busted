...
describe("self-time", function()
    ...
    it("works with only multiple direct children + multiple inner child per child #nested", function()
        _P.run_simple_test({
            { cat = "function", dur = 9, name = "prefix", tid = 1, ts = -17 },
            { cat = "function", dur = 1, name = "prefix_child_1_1", tid = 1, ts = -14 },

            { cat = "function", dur = 10, name = "outer_most", tid = 1, ts = 0 },
            { cat = "function", dur = 6, name = "first_child", tid = 1, ts = 1 },
            { cat = "function", dur = 1, name = "inner_child_1_1", tid = 1, ts = 2 },
            { cat = "function", dur = 1, name = "inner_child_1_2", tid = 1, ts = 3 },
            { cat = "function", dur = 1, name = "inner_child_1_3", tid = 1, ts = 4 },
            { cat = "function", dur = 2, name = "second_child", tid = 1, ts = 8 },
            { cat = "function", dur = 1, name = "inner_child_2_1", tid = 1, ts = 9 },
            { cat = "function", dur = 1, name = "inner_child_2_2", tid = 1, ts = 10 },
            { cat = "function", dur = 1, name = "inner_child_2_3", tid = 1, ts = 11 },
            { cat = "function", dur = 2, name = "another_event_that_is_past", tid = 1, ts = 11 },
        }, {
            {
                count = 1,
    ...
    it("works with really high precision numbers", function()
        _P.run_simple_test({
            { cat = "function", dur = 10.000000000000000000000001, name = "outer_most", tid = 1, ts = 0 },
            { cat = "function", dur = 6, name = "first_child", tid = 1, ts = 1 },
            { cat = "function", dur = 1, name = "inner_child_1_1", tid = 1, ts = 2 },
            { cat = "function", dur = 1, name = "inner_child_1_2", tid = 1, ts = 3 },
            { cat = "function", dur = 1, name = "inner_child_1_3", tid = 1, ts = 4 },
            ...
            { cat = "function", dur = 1, name = "inner_child_2_3", tid = 1, ts = 11 },
            {
                cat = "function",
                dur = 2,
                name = "another_event_that_is_past",
                tid = 1,
                ts = 10.000000000000000000000002,
            },
        }, {
            {
                count = 1,
