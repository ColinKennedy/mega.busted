...
---
---@param text string Any text, e.g. `"mega.busted.ClassName"`.
---@return string # The wrapped text, e.g. `"*mega.busted.ClassName*"`.
---
...
---    The real name for the module. e.g. `"mega.busted"`.
---
...
---@class mega.busted.AutoDocumentationEntry
...
---    e.g. `"/out/mega.busted.txt"`.

--- Make sure `paths` can be processed by this script.
---
---@param paths mega.busted.AutoDocumentationEntry[]
...
local function main()
    ...
    local paths = {
        ...
        {
            source = vim.fs.joinpath(root, "lua", "mega", "busted", "types.lua"),
            destination = vim.fs.joinpath(root, "doc", "mega_busted_types.txt"),
        },
    }
